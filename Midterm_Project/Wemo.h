...
class Wemo {                          //creating class
  EthernetClient WemoClient;
  
  int wemoPort = 49153;
  char *wemoIP[4] = {"192.168.1.4","192.168.1.6","192.168.1.8","192.168.1.7"};

  public:
    Wemo() {                          //defining-declares object
    }
    
    void switchON(int wemo) {         //method for turning the Wemo On
      String data1;
...
void switchOFF(int wemo){           //method for turning the Wemo Off
  String data1;
